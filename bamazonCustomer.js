...
function start() {
	...
	inquirer.prompt ([
		{
			name: "productId",
			type: "input",
			//***Unsuccessfull in trying to grab the item which the user selects, for future use***
			// choices: function(value) {
   //          var productIdArray = [];
   //          for (var i = 0; i < res.length; i++) {
   //            productIdArray.push(res[i].item_name);
   //          }
   ...
   //        },
		...
		},
		{
			...
			type: "input",
			// choices: function() {
   //          var purchaseQuantityArray = [];
   //          for (var i = 0; i < res.length; i++) {
   //            purchaseQuantityArray.push(res[i].item_id);
   //          }
